...
function Invoke-AES-Encoder {
    ...
    .EXAMPLE
    PS> Import-Module ./AES-Encoder.ps1
    PS> Invoke-AES-Encoder -InFile invoke-mimikatz.ps1 -OutFile aesmimi.ps1
    The number of times the PowerShell script will be packed & crypted recursively. Default is 4
    ...
    Process {
      ...
      Write-Host -ForegroundColor White  "                         ║                                         ║                   "
      Write-Host -ForegroundColor Blue   "                         ║            Let's fool that AV!          ║                   "
      Write-Host -ForegroundColor White  "                         ║         I Do Me . . . You Do You        ║                   "
      Write-Host -ForegroundColor Red    "                         ║                                         ║                   "
      Write-Host -ForegroundColor White  "                         ║                                         ║                   "  
      Write-Host -ForegroundColor Blue   "                         ╚═════════════════════════════════════════╝                   "  
