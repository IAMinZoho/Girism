...
$usage = "`n[*] Possible Usage:`n`n[*] Show help message:`n`tMrKaplan help`n`n[*] For config creation and start:`n`tMrKaplan begin`n`tMrKaplan begin -Users Reddington,Liz`n`tMrKaplan begin -Users Reddington`n`tMrKaplan begin -EtwBypassMethod overflow`n`tMrKaplan begin -RunAsUser`n`tMrKaplan begin -Exclusions BamKey, OfficeHistory`n`n[*] For cleanup:`n`tMrKaplan end`n`n[*] To save file's timestamps:`n`tMrKaplan timestomp -StompedFilePath C:\path\to\file`n`n"
